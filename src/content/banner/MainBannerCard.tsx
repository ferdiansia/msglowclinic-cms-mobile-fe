import { Card, CardContent, CardHeader, CardMedia, IconButton, Tooltip, Typography, useTheme } from "@mui/material"
                ...
                <CardHeader
                    action={
                        <Tooltip title="Edit" arrow>
                            <IconButton
                                onClick={() => props.handleEditData(mainBannerData?.[`${props.type}-banner`]?.[0])}
                                sx={{
                                    '&:hover': {
